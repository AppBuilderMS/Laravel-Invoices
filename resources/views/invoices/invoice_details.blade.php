                    ...
                    <div class="nav-tabs-custom " id="form_tabs">
                        ...
                        <div class="tab-content p-0 ">
                            ...
                            <div role="tabpanel" class="tab-pane pb-0" id="attatchments">
                                @if(authUserPermission('Add an attachment'))
                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        @foreach ($invoice->attachments as $index => $attachment)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('filePreview', [$invoice->created_at->format('m-Y'), $attachment->invoice_number, $attachment->file_name])}}" class="btn btn-ghost-info btn-sm" target="_blank">
                                                        <i class="la la-eye"></i>
                                                        {{trans('projectlang.preview')}}
                                                    </a>
                                                    <a href="{{route('fileDownload', [$invoice->created_at->format('m-Y'), $attachment->invoice_number, $attachment->file_name])}}" class="btn btn-ghost-success btn-sm">
                                                        <i class="la la-download"></i>
                                                        {{trans('projectlang.download')}}
                                                    </a>
                                                    @if(authUserPermission('Delete an attachment'))
                                                        <button
