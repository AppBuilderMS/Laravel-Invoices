            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-start">
                    ...
                    @if(authUserPermission('Export Excel'))
                        <a href="{{route('invoicesExportExcel')}}"  class="btn btn-success mb-2 ml-1 mr-1">
...
{{--                                    <td>{{$lang === 'ar' ? $invoice->notes_ar : $invoice->notes_en}}</td>--}}
                                    ...
                                    <td>
                                        ...
                                        {{--@if($invoice->value_status == 1)--}}
                                        @if(authUserPermission('Archive an invoice'))
                                        ...
                                        @endif
                                        {{--@endif--}}
                                        @if(authUserPermission('Delete an invoice'))
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('projectlang.archive_invoice')}}</h5>
