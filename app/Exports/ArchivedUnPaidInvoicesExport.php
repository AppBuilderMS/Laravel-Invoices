...
//class ArchivedUnPaidInvoicesExport implements FromCollection
//{
//    /**
...
class ArchivedUnPaidInvoicesExport implements FromQuery, WithMapping, WithHeadings
{
    use Exportable;

    public function query()
    {
        return Invoice::onlyTrashed()->where('value_status', 3);
    }
