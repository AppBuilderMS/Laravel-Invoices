...
//class ArchivedPartiallyPaidInvoicesExport implements FromCollection
//{
//    /**
...
class ArchivedPartiallyPaidInvoicesExport implements FromQuery, WithMapping, WithHeadings
{
    use Exportable;

    public function query()
    {
        return Invoice::onlyTrashed()->where('value_status', 2);
    }
