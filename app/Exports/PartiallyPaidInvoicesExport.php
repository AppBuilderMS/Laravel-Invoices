...
//class PartiallyPaidInvoicesExport implements FromCollection
//{
//    /**
...
class PartiallyPaidInvoicesExport implements FromQuery, WithMapping, WithHeadings
{
    use Exportable;

    public function query()
    {
        return Invoice::query()->where('value_status', 2);
    }
